...
- imagePrompt: AI画像生成に渡す、そのシーンの場面を表す短い英語の説明(20語程度)。
  【最重要】そのシーンのtext/narrationで実際に語られている具体的な瞬間・行動・場所・小道具を
  そのまま写真にすること。「オフィスにいる人物」のような、どのシーンにも当てはまる一般的な絵に
  しないこと。例えば、そのシーンが「朝6時半、検査ラインで」「見きれない壁」のような内容なら、
  作業着姿の人物が早朝の検査ラインの前で計器を確認している、机の書類が積み上がって視界を
  遮っている、といった、その場面ならではの具体的な描写にする。シーンごとに画角・人物の動作・
  場所・時間帯を変え、6シーン全部が似たような1枚の使い回しに見えないようにする。
  実写のドキュメンタリー風写真として描写すること(イラストやアニメ風にしない)。文字・数字・
  ロゴを画像に含めないこと。実在の人物や会社が特定できる描写は避け、一般化した人物・場所として
  描写する
